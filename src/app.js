...
function sendOneTimeMessage(sender,callback) {
    console.log("inside One Time Message Function ");
    request({
        url: 'https://graph.facebook.com/v2.6/me/messages',
        qs: {access_token: FB_PAGE_ACCESS_TOKEN},
        method: 'POST',
            ...
            message: {
                "attachment": {
                  ...
                  "payload": {
                    ...
                    "title":"Notify me when next coupon code comes.",
                    "payload":"RecordForNotification"
                  }
                }
              }
        }
...
app.get('/optionspostback', (req, res) => {
    let body = req.query;
    let response = `Well Played, Your 20% coupon code: XDSH34.`
